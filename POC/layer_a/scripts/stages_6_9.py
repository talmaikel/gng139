...
# ‏'בית ספר ירוק (שם זמני)' הופיע כאן פעם. הוא לא מופיע במדיניות — הוא היה
# שם שהמצאתי כדי לכסות אזור שלא זיהיתי, והוא היה מזכה אזור אמיתי ברצפת 400
# בלי מקור. אזור שאינו ברשימה מעלה Undefined, וזו התשובה הנכונה.
