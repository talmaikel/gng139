...
async function openDossier(id){try{
  ...
  const panels={id:groupsHTML(d,['זהות הנכס'],used),
    ...
    plan:groupsHTML(d,['הכרעת תנאי הסף'],used),
