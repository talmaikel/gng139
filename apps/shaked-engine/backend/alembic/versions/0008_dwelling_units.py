...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("declared_unit_count", sa.Integer(), nullable=True),
        sa.Column("is_plausible", sa.Boolean(), nullable=False, server_default=sa.true()),
        sa.Column("plausibility_reason", sa.Text(), nullable=True),
