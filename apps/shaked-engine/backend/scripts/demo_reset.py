...
המסירות הישנות מ-13.09 נשארות — זו הכרעה נפרדת (A23). וגם תמהיל שנשמר על
חלקות ההדגמה (B15, לפני W8). התיק כבר אינו קורא אותו — התמהיל חי במחשבון
התרחיש ואינו נשמר — אבל ההזדמנות משותפת לכל החברות, ותמהיל שנשאר עליה עדיין
משקלל את הערכת השווי (`market_data`).
